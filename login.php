...
<head>
	...
	<body>
		...
		<div class="container">	
			<div class="row">
				<div class="col s12">
					<div class="card-panel hoverable" style="margin:50px 315px 0px 315px; padding-bottom: 100px;">
						...
						<span class="white-text">
							<form method="post">
								...
								<div class="input-field">
									...
									<input id="icon_captcha" type="text" class="validate" name="captcha" required autocomplete="off">
									<label for="icon_captcha">Captcha</label>
									<img src="captcha.php" alt="CAPTCHA"> <!-- Menampilkan gambar CAPTCHA -->
								</div>
